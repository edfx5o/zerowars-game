...
public class Heatnix extends Entity{

	private Queue<KeyEvent> keyQueue;
	
	private Sprite heatnix;
	...
	)
	{
		...
		this.id = id;
		this.name = name;
		this.para1 = (int)this.x - 100;
		this.para2 = (int)this.x + 400;
		
		heatnix = new Sprite(ref,x,y,id,"Sprite: "+name);						
		
		FlyingRight = new ReverseAnimation("images/heatnixFR.png",x,y,4,60,id,"Sprite: "+name);
		FlyingLeft = new AnimatedSprite("images/heatnixFL.png",x,y,4,60,id,"Sprite: "+name);				
		
		this.h = heatnix.getH();
		this.w = heatnix.getW()/4;
		this.c = c;
		this.bm = bm;
		this.hm = hm;
		this.currentSprite = this.heatnix;
